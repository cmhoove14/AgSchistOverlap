...
```{r}
nga_sf <-  load_sf_from_googledrive('1k36AebJC7EA10R1Zmnhcl9DiwOiszkzJ')
...
loc1 <- load_dta_from_googledrive('1IsvLf6MzyMlrTtEiCTuccxg9-KRJGL8m')
loc1
#NGA_householdgeovars_y2.dta
loc2 <- load_dta_from_googledrive("1kBoIidqMO7L32wdnd1fc3YhudPH7h4Yd")
loc2 

#NGA_householdgeovars_y3.csv
loc3 <- load_csv_from_googledrive("1BEcuOimK1RpIQLvJCwo8EoMHNziGH4Vz")
loc3
```
...
```{r}
w1_fert <- data.frame(country="nigeria", start_yr = 2010, end_yr = 2011, fert1_joined, stringsAsFactors = FALSE) 
w2_fert <- data.frame(country="nigeria", start_yr = 2012, end_yr = 2013, fert2_joined)
w3_fert <- data.frame(country="nigeria", start_yr = 2015, end_yr = 2016, fert3_joined)
```
