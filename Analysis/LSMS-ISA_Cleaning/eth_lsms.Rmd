...
```{r}
eth_zone <- load_sf_from_googledrive('1zArP52rGPi-C5uhrwyH3L6CJJqiM_6GJ')
...
# original filename: pub_eth_householdgeovariables_y1.csv
geo1 <- load_csv_from_googledrive('12ERO4j1LjJdRNQdePwXOBr-sItZScT_q')
...
#filename Pub_ETH_HouseholdGeovars_Y2.dta
geo2 <- load_dta_from_googledrive('1CQ26y1bTmSgHDlv0nPDXut6OqetaUx51')
loc2 <- geo2 %>% select(household_id2, longitude=lon_dd_mod, latitude=lat_dd_mod)

#filename ETH_HouseholdGeovars_y3.csv
geo3 <- load_csv_from_googledrive('1p4tKtkBnCNKpV95bbhKTgJb6DeG8Favz')
...
```{r, eval=FALSE}
# configure a filepath to write the output
